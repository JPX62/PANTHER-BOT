...
from Panther.helpers.pyrohelper import get_arg, welcome_chat
import Panther.database.welcomedb as Pantherdb
...
async def welcome(client, message):
    await Pantherdb.clear_welcome(str(message.chat.id))
...
async def new_welcome(client, message):
    msg_id = await Pantherdb.get_welcome(str(message.chat.id))
    caption = ""
    men = ""
...
async def setwelcome(client, message):
    ...
    await Pantherdb.save_welcome(str(message.chat.id), msg_id)
